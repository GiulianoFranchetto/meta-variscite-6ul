...
function flash_yocto
{
    ...
    tar xvpf tmp/deploy/images/imx6ul-var-dart/itl-dev-image-imx6ul-var-dart.tar.bz2 -C /tmp/rootfs/ 2>&1 |
    while read line; do
        x=$((x+1))
...
sudo cp tmp/deploy/images/imx6ul-var-dart/itl-dev-image-imx6ul-var-dart.tar.bz2 	/tmp/rootfs/opt/images/Yocto/rootfs.tar.bz2
#sudo cp tmp/deploy/images/imx6ul-var-dart/itl-dev-image-imx6ul-var-dart.ubi 		/tmp/rootfs/opt/images/Yocto/rootfs.ubi.img
#sudo cp tmp/deploy/images/imx6ul-var-dart/itl-dev-image-imx6ul-var-dart.sdcard 		/tmp/rootfs/opt/images/Yocto/rootfs.sdcard
#
...
{
echo "scripts..."
sudo cp  ../meta-variscite-6ul/scripts/var_mk_yocto_sdcard/variscite_scripts/nand-recovery.sh 	/tmp/rootfs/sbin/
sudo cp  ../meta-variscite-6ul/scripts/var_mk_yocto_sdcard/variscite_scripts/yocto-nand.sh    	/tmp/rootfs/sbin/
sudo cp  ../meta-variscite-6ul/scripts/var_mk_yocto_sdcard/variscite_scripts/yocto-emmc.sh     /tmp/rootfs/sbin/
#
...
#
echo "desktop icons..."
sudo cp ../meta-variscite-6ul/scripts/var_mk_yocto_sdcard/variscite_scripts/*.desktop      	/tmp/rootfs/usr/share/applications/ 
sudo cp ../meta-variscite-6ul/scripts/var_mk_yocto_sdcard/variscite_scripts/terminal*      	/tmp/rootfs/usr/bin
}
